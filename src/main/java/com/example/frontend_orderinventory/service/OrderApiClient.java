...
public class OrderApiClient {
    ...
    public OrderApiClient(HttpClient httpClient, ObjectMapper objectMapper, @Value("${backend.api.url}") String baseUrl) {
    ...
    public OrderDTO save(OrderDTO dto) throws Exception {
        ...
        if (dto.getOrderId() == null) {
            ...
            builder.uri(URI.create(baseUrl + "/" + dto.getOrderId())).PUT(HttpRequest.BodyPublishers.ofString(json));
        }
    ...
    public List<OrderDTO> findByCustomerId(Integer customerId) throws Exception {
        // The backend endpoint is /api/customers/{id}/orders
        String url = baseUrl.replace("/orders", "") + "/customers/" + customerId + "/orders";
